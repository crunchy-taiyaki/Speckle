...
class FitParametersReader:
    ...
    def read(self,file):
        ...
        self.method = info[3]
        self.dm21 = self.to_float(info[4])
        self.dm21_bottom = self.to_float(info[5])
        self.dm21_upper = self.to_float(info[6])
        self.x2 = self.to_float(info[7])
        self.x2_bottom = self.to_float(info[8])
        self.x2_upper = self.to_float(info[9])
        self.y2 = self.to_float(info[10])
        self.y2_bottom = self.to_float(info[11])
        self.y2_upper = self.to_float(info[12])

        if self.star_type == 'triple':
            self.dm31 = self.to_float(info[13])
            self.dm31_bottom = self.to_float(info[14])
            self.dm31_upper = self.to_float(info[15])
            self.x3 = self.to_float(info[16])
            self.x3_bottom = self.to_float(info[17])
            self.x3_upper = self.to_float(info[18])
            self.y3 = self.to_float(info[19])
            self.y3_bottom = self.to_float(info[20])
            self.y3_upper = self.to_float(info[21])
