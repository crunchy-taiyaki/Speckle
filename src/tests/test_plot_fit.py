...
plt.figure()
plt.plot(slice_image(data.final_ps,x1=56,y1=256,x2=253.546,y2=253.277))
...
plt.figure()
plt.plot(slice_image(data.final_ps,x1=256,y1=256,x2=512,y2=512))
ymin,ymax=define_ylim(data.final_ps)
plt.ylim(ymin,ymax)
